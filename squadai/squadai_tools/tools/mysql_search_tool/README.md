...
## Installation
To install the `squadai_tools` package and utilize the MySQLSearchTool, execute the following command in your terminal:
...
```python
from squadai_tools import MySQLSearchTool
